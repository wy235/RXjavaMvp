...
public class PlayerActivity extends AppCompatActivity
    ...
    private void initializePlayer() {
        if (player == null) {
            ...
            RenderersFactory renderersFactory =
                    ((BaseAplication) getApplication()).buildRenderersFactory(preferExtensionDecoders);
    ...
    private MediaSource buildMediaSource(Uri uri, @Nullable String overrideExtension) {
        DownloadRequest downloadRequest =
                ((BaseAplication) getApplication()).getDownloadTracker().getDownloadRequest(uri);
    ...
    private DefaultDrmSessionManager<FrameworkMediaCrypto> buildDrmSessionManagerV18(
        ...
        HttpDataSource.Factory licenseDataSourceFactory =
                ((BaseAplication) getApplication()).buildHttpDataSourceFactory();
    ...
    private DataSource.Factory buildDataSourceFactory() {
        return ((BaseAplication) getApplication()).buildDataSourceFactory();
    }
